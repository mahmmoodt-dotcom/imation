...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col transition-colors duration-300 dark:bg-gray-950">
      ...
      <footer className="bg-white dark:bg-gray-900 border-t dark:border-gray-800 pt-32 pb-12 px-4 mt-24 transition-colors">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
            <div className="col-span-1 lg:col-span-1">
              <h2 className="text-5xl font-black text-brand mb-6 lowercase tracking-tighter">imation</h2>
              <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-8 font-medium">
                {aboutText}
              </p>
              <div className="flex gap-4">
                 {settings?.socials?.facebook && (
                   <a href={settings.socials.facebook} target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center bg-gray-50 dark:bg-gray-800 rounded-2xl text-gray-400 hover:bg-brand hover:text-white transition-all transform hover:-translate-y-1">
                     <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                   </a>
                 )}
                 {settings?.socials?.instagram && (
                   <a href={settings.socials.instagram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 flex items-center justify-center bg-gray-50 dark:bg-gray-800 rounded-2xl text-gray-400 hover:bg-brand hover:text-white transition-all transform hover:-translate-y-1">
            ...
            <div className="col-span-1">
              ...
              <ul className="space-y-5">
                <li className="text-gray-500 dark:text-gray-400 text-sm font-semibold flex items-center gap-3">
                  <div className="w-10 h-10 flex items-center justify-center bg-gray-50 dark:bg-gray-800 rounded-xl text-brand">
            ...
            <div className="col-span-1">
              ...
              <button 
                ...
                className="group w-full px-5 py-4 bg-gray-50 dark:bg-gray-800 rounded-3xl border dark:border-gray-700 flex items-center gap-3 hover:bg-brand transition-all shadow-sm"
              >
                <div className="w-10 h-10 flex items-center justify-center bg-white dark:bg-gray-700 rounded-2xl group-hover:bg-white/20 transition-colors shadow-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-brand group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="pt-10 border-t dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">
            <p>© {new Date().getFullYear()} imation Shop. Crafted for High Performance.</p>
